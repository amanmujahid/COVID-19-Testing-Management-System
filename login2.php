...
if(isset($_POST['login']))
  {
    ...
    if($ret>0){
      $_SESSION['aid']=$ret['ID'];
     header('location:assigned-test2.php');
    }
    else{
...
<head>
    ...
    <title>Covid 19 Testing Management System | Sample Collector Login</title>
...
<body class="bg-gradient-primary">
 ...
 <h3 align="center" style="margin-top:4%;color:#fff">Wellness Infinity Sample Collector Login</h3>
