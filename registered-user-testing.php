        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Already Registered User</h1>
...
<form method="post">
  <div class="row">
                       ...
                       <div class="form-group">
                                             <label>Registered Mobile Number (+880)</label>
...
<div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="search" value="Enter">                           
                             </div>
                       ...
                       <div class="form-group">
                                             <label>OTP</label>
                                            <input type="text" class="form-control" id="otp" name="otp" placeholder="Please enter your otp" pattern="[0-9]{10}" title="10 numeric characters only" required="true" maxlength="10">
                                        </div>
<div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="search" value="Submit">                           
                             </div>
							 <!--- OTP --->
...
<h3 align="center" style="color:red"> <?php echo $_POST['regmobilenumber'];?></h3>
<hr />
    <?php
...
<form name="newtesting" method="post">
 ...
 <div class="form-group">
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Book a Test</h6>
                                </div>
                                <div class="card-body">
                             <div class="form-group">
                                            ...
                                            <option value="">Select</option> 
                                            <option value="Antigen"> Rapid Antigen Test (COVID-19)- Tk 2000</option>  
                                            <option value="RT-PCR">RT-PCR Test (COVID-19) - Tk 3000</option>
                                            <option value="CB-NAAT">CB-NAAT (Tuberculosis)- Tk 2000</option>
											<option value="NS1 Antigen">NS1 Antigen (Dengue) - Tk 2500</option>
                                              </select>
                                        </div>
						...
						<div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                             ...
                             <div class="form-group">
                                              ...
                                              <select class="form-control" id="testtype2" name="testtype2" required="true">
                                            <option value="">Select</option> 
