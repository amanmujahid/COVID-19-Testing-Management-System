...
echo "<script>window.location.href='assigned-test2.php'</script>";
    }
...
<div class="row">
                         <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary" align="center"></h6> <!-- text removed -->
                                </div>
                                <div class="card-body">
<?php if($num>0){
?>
...
<h4 align="center" style="color:red">  </h4> <!-- text removed -->
         <?php } ?>           
...
<!-- Unique pin -->
<p>
<textarea name="remark2" class="form-control" required="true" placeholder="Enter your unique pin" maxlength="100" rows="1"></textarea>  </p>
<!-- End of unique pin --> 
