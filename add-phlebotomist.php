...
if ($result) {
echo '<script>alert("Sample Collector created successfully.")</script>';
...
<head>
    ...
    <title>Covid-19 Testing Management System | Add Sample Collector</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add Sample Collector</h1>
