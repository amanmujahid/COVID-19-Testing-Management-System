        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Test Booking</h1>
                        ...
                        <div class="form-group">
                            <label>Full Name</label>
                                  ...
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Please enter your mobile number" pattern="[0-9]{10}" title="10 numeric characters only" required="true" onBlur="mobileAvailability()">
										...
										<!---
                                        <div class="form-group">
                                               <label>Type of Govt Issued ID</label>
                                            <input type="text" class="form-control" id="govtissuedid" name="govtissuedid" placeholder=" Passport / NID / Driving License" required="true">
                                        </div>
										--->
										
										<div class="form-group">
                                              <label>Type of Govt Issued ID</label>
                                              <select class="form-control" id="govtissuedid" name="govtissuedid" required="true">
